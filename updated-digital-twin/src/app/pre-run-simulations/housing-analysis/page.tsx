      ...
      <section className="bg-gray-800 p-6 rounded-lg">
        ...
        <div className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Home ownership status affects decision-making patterns</li>
            <li>Renters show different provider switching behaviors</li>
            <li>Length of residence impacts willingness to change</li>
          </ul>
        </div>
      </section>
    </div>
