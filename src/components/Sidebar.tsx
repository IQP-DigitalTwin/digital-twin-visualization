...
export default function Sidebar() {
	...
	return (
		<div
			className={`h-[95vh] bg-background text-primary p-4 w-20 relative z-50 rounded-r-3xl my-4 shadow-lg transform origin-left transition-all duration-200 ease-in-out ${
				isExpanded ? "w-48" : ""
			}`}
		...
		>
			...
			>
				...
				{isExpanded && (
					<span
						className={`whitespace-nowrap transition-opacity delay-100 duration-100 ${
